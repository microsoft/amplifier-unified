...
const phaseLabels={'candidate-install':'Prepare application','candidate-probe':'Check candidate package','candidate-version':'Check candidate version','candidate-record':'Save candidate validation','target-discovery':'Find active installation','runtime-close':'Stop idle runtimes','recovery-record':'Save recovery reference','replacement-install':'Install application','replacement-probe':'Check installed package','replacement-version':'Check installed version','restart-configuration':'Prepare restart settings','restart-helper-file':'Prepare restart helper','restart-helper':'Start restart helper','service-restart':'Restart system service','service-restart-request':'Request service restart','restart-request':'Request restart','restart-readiness':'Check restarted host readiness','restart-ack':'Confirm restarted version','restart-reconcile':'Verify current installation','activation-validation':'Check staged release','ecosystem-copy':'Prepare ecosystem copy','ecosystem-fetch':'Fetch source update','ecosystem-checkout':'Switch staged source','ecosystem-probe':'Check bundles and modules','ecosystem-activation':'Activate ecosystem','ecosystem-stage':'Prepare ecosystem','stage':'Prepare application update'};
...
export function diagnosticReceipt(diagnostics,reconciliation){
 const fields=['id','at','attemptId','kind','phase','status','revision','commandId','durationMs','exitCode','stdoutBytes','stderrBytes','errorType','timedOut','expectedVersion','observedVersion','expectedRevision','observedRevision'];
 const clean=event=>{
