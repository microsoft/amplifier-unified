...
import {WorkHeader,WorkSurface,AppFooter,ComposerWorkspace,WorkspaceCreation} from './work-shell';
...
function App(){
 ...
 async function newChat(workspace){preserveOtherDraft(null);stickToBottom.current=true;await act('session.draft',workspace?{workspace}:latest.current?.view?.newSessionDraft?{}:{location:{kind:'managed'}})}
