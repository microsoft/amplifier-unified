...
function App(){
 ...
 const dispatch=useCallback((action,args={},meta={})=>{
  ...
  const queue=action.startsWith('coordination.')?{current:Promise.resolve()}:navigation?navigationQueue:exactReview?reviewQueue:['conversation.send','message.edit'].includes(action)?sendQueue:commandQueue;
