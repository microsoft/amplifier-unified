...
- 73 focused backend/runtime tests pass, including real worker IPC, persisted state reload, older-Core fallback, private file permissions, native-history fallback, current report precedence and clearing.
