...
ACTION_DEFINITIONS = {
    ...
    "providers.credentials": ("Check provider credential environment availability without revealing values",schema({"module":string(200),"envVar":string(200)},["module"])),
    "providers.list": ("List provider connections and setup status",schema()),
    "providers.save": ("Add or edit a provider connection",schema({"id":string(200),"module":string(200),"source":string(4000),"config":{"type":"object"},"apiKey":string(16000),"apiKeyEnv":string(200),"scope":{"enum":["global","project","local"]}},["module","config"])),
