...
def test_shared_session_id_search_keeps_app_keys_and_workspace_scope():
    ...
    assert ids(chat_navigation.snapshot(state)) == ['ae543fd8-808b-4375-93bd-96d3f150454d']
