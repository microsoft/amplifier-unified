...
def main():
    ...
    parser.add_argument('--bundle',type=Path,required=True);parser.add_argument('--module-root',type=Path,required=True);parser.add_argument('--output',type=Path,required=True)
